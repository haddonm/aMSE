...
#' @importFrom stats loess optim ccf filter optimize
...
#' @importFrom codeutils confirmdir getmatcolfromlist countNAs iscol countgtzero
#' @importFrom hplot parset plotprep pickbound RGB makepolygon plotcompdata
#' @importFrom hplot inthist plotnull
