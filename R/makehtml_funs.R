...
#' @title add_css writes out CSS commands for inclusion in htmlfile
#'
#' @description add_css write the css commands into the htmlfile being
...
#'     the code.
#'
#' @param htmlfile the name of the htmlfile being worked on, either
