...
biology_plots <- function(rundir, glb, zoneC, matL=c(30,210), Lwt=c(80,210)) {
  ...
  hist(resultpop["M",],xlab="M",main="",breaks=16)
  hist(resultpop["MSY",],xlab="MSY",main="",breaks=16)
  hist(resultpop["MaxDL",],xlab="MaxDL",main="",breaks=16)
  hist(resultpop["L50",],xlab="L50",main="",breaks=16)
  hist(resultpop["L95",],xlab="L95",main="",breaks=16)
  hist(resultpop["steep",],xlab="steep",main="",breaks=16)
  hist(resultpop["bLML",],xlab="bLML",main="",breaks=16)
...
#'     and zoneprod the productiivty matrix for the zone, and sauprodzone,
#'     which is sauprod but with the zone totals added.
#' @export
#'
#' @examples
#' print("this will be quite long when I get to it")
