...
This is the codebase for an Abalone Management Strategy Evaluation framework, which we call **aMSE**. It has a novel structure that is based around the spatial ideas of populations (or areas of persistent production or apps, reflecting how they are defined), within spatial management units (SAUs), within a zone:
...
The working of the **aMSE** software and how to use it has been documented during the developemt and this is available as a GitBook at:

https://haddonm.github.io/aMSEGuide/

That can ether be read online or a PDF of the whole downloaded (look for the
small Acrobat symbool at top left).
...
See the _aMSEGuide_ for detailed examples.
