...
The change in the harvest strategy is implemented in the hsargs rather than in the code, although it is necessary to let the do_MSE() function know of the change:
