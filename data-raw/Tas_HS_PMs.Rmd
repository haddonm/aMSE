...
score1 <- getscore1(grad1)  # examine the code using getscore1 without brackets
...
```{r  echo=TRUE}
grad4 <- getgrad4(grad1,wid=4) # uses five years of data; red in the figure 
grad3 <- getgrad4(grad1,wid=3) # uses four years of data; blue in the figure
range(grad4)
range(grad3)
```
...
plot(0:27,c(NA,grad1),type="l",lwd=2)        # black
lines(0:27,c(NA,NA,NA,NA,grad4),col=2,lwd=2) # red
lines(0:27,c(NA,NA,NA,grad3),col=4,lwd=2)    # blue
abline(h=0.0,col=3)
