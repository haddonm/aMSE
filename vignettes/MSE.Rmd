...
knitr::include_graphics(paste0(ddir,"/A_Code/aMSEUse/figures/structure_of_MSE.png"))
```
...
```{r  echo=FALSE, out.width = '80%'}
knitr::include_graphics(paste0(ddir,"/A_Code/aMSEUse/figures/structure_of_zone.png"))
```
